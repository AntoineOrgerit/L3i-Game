...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mar. 01 oct. 2019 à 15:01
...
CREATE TABLE IF NOT EXISTS `niveau` (
  ...
  `coeff_min` decimal(10,2) NOT NULL,
  `coeff_max` decimal(10,2) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
...
INSERT INTO `niveau` (`id`, `intitule`, `score`, `penalite_mauvaise_reponse`, `t_min`, `t_max`, `coeff_min`, `coeff_max`) VALUES
(1, 'Facile', 100, 5, '3.50', '5.00', '1.10', '0.90'),
(2, 'Moyen', 200, 12, '5.00', '7.00', '1.25', '0.80'),
(3, 'Difficile', 300, 22, '7.00', '9.00', '1.35', '0.70');
